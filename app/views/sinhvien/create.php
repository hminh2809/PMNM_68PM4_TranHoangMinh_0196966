        ...
        <main class="page-content">
            <div class="app-shell">
                <div class="soft-card form-card">
                    <div class="mb-4">
                        <a class="text-secondary fw-semibold" href="/PMNM_68PM4_TranHoangMinh_0196966/public/sinhvien/index/"> <- Quay lại danh sách</a>
                        <h1 class="h3 fw-bold mt-3 mb-1">Thêm sinh viên</h1>
                        <p class="text-secondary mb-0">Nhập thông tin sinh viên mới.</p>
                    </div>

                    <form action="/PMNM_68PM4_TranHoangMinh_0196966/public/sinhvien/store" method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="form-control" type="text" name="mssv" id="mssv" placeholder="Ví dụ: 0196966" required>
                        </div>
