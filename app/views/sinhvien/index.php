<div class="app-shell student-page">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3 mb-4">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a class="btn btn-success" href="/PMNM_68PM4_TranHoangMinh_0196966/public/sinhvien/create">Thêm sinh viên</a>
        </div>
    </div>

    <form class="mb-4" action="/PMNM_68PM4_TranHoangMinh_0196966/public/sinhvien/index/<?php echo htmlspecialchars($pageSize ?? 5); ?>/0" method="get">
        <div class="row g-2">
            <div class="col-md-5">
                <input
                    class="form-control"
            ...
            <div class="col-md-2 d-flex gap-2">
                ...
                <a class="btn btn-outline-secondary" href="/PMNM_68PM4_TranHoangMinh_0196966/public/sinhvien/index/">Reset</a>
            </div>
        </div>
    </form>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        <a class="btn btn-sm btn-primary" href="/PMNM_68PM4_TranHoangMinh_0196966/public/sinhvien/edit/<?php echo htmlspecialchars($sinhvien['id']); ?>">Sửa</a>
                                        <a class="btn btn-sm btn-danger" href="/PMNM_68PM4_TranHoangMinh_0196966/public/sinhvien/delete/<?php echo htmlspecialchars($sinhvien['id']); ?>" onclick="return confirm('Bạn có chắc muốn xóa sinh viên này?')">Xóa</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; ?>
        ...
        <ul class="pagination justify-content-center">
            ...
            ?>
                <li class="page-item <?php echo $activeClass; ?>">
                    <a class="page-link" href="/PMNM_68PM4_TranHoangMinh_0196966/public/sinhvien/index/<?php echo $pageSize; ?>/<?php echo $pageOffset; ?>?search=<?php echo urlencode($search ?? ''); ?>&sort=<?php echo urlencode($sort ?? 'id'); ?>&dir=<?php echo urlencode($dir ?? 'ASC'); ?>&pageSize=<?php echo urlencode($pageSize); ?>">
                        <?php echo $i; ?>
                    </a>
                </li>
            <?php endfor; ?>
