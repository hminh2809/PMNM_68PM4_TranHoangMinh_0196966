<div class="app-shell student-page">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3 mb-4">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a class="btn btn-success" href="/PMNM_68PM4_TranHoangMinh_0196966/public/lop/create">Thêm lớp</a>
        </div>
    </div>

    <form class="mb-4" action="/PMNM_68PM4_TranHoangMinh_0196966/public/lop/index/<?php echo htmlspecialchars($pageSize ?? 5); ?>/0" method="get">
        <div class="row g-2">
            <div class="col-md-5">
                <input
                    class="form-control"
            ...
            <div class="col-md-2">
                <select class="form-select" name="sort">
                    ...
                    <option value="malop" <?php echo ($sort ?? '') === 'malop' ? 'selected' : ''; ?>>Mã lớp</option>
                    <option value="tenlop" <?php echo ($sort ?? '') === 'tenlop' ? 'selected' : ''; ?>>Tên lớp</option>
                </select>
            </div>
            ...
            <div class="col-md-2 d-flex gap-2">
                ...
                <a class="btn btn-outline-secondary" href="/PMNM_68PM4_TranHoangMinh_0196966/public/lop/index/">Reset</a>
            </div>
        </div>
    </form>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        <a class="btn btn-sm btn-primary"
                                           href="/PMNM_68PM4_TranHoangMinh_0196966/public/lop/edit/<?php echo htmlspecialchars($lop['id']); ?>">
                                            Sửa
                                        </a>

                                        <a class="btn btn-sm btn-danger"
                                           href="/PMNM_68PM4_TranHoangMinh_0196966/public/lop/delete/<?php echo htmlspecialchars($lop['id']); ?>"
            ...
            <ul class="pagination justify-content-center">
                ...
                ?>
                    <li class="page-item <?php echo $activeClass; ?>">
                       <a class="page-link" href="/PMNM_68PM4_TranHoangMinh_0196966/public/lop/index/<?php echo $pageSize; ?>/<?php echo $pageOffset; ?>?search=<?php echo urlencode($search ?? ''); ?>&sort=<?php echo urlencode($sort ?? 'id'); ?>&dir=<?php echo urlencode($dir ?? 'ASC'); ?>&pageSize=<?php echo urlencode($pageSize); ?>">
                            <?php echo $i; ?>
                        </a>
                    </li>
                <?php endfor; ?>
