    ...
    <main class="page-content">
        <div class="app-shell">
            <div class="soft-card form-card">
                <div class="mb-4">
                    <a class="text-secondary fw-semibold" href="/PMNM_68PM4_TranHoangMinh_0196966/public/lop/index/"> <- Quay lại danh sách</a>
                    <h1 class="h3 fw-bold mt-3 mb-1">Thêm lớp</h1>
                    <p class="text-secondary mb-0">Nhập thông tin lớp mới.</p>
                </div>

                <form action="/PMNM_68PM4_TranHoangMinh_0196966/public/lop/store" method="post">
                    <div class="mb-3">
